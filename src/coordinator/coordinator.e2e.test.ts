...
describe("coordinator desktop-independent execution", () => {
  it("continues a fixture-backed run after the initiating HTTP client disconnects", async () => {
    ...
    try {
      const graph = graphDefinitionV2Schema.parse({
        ...
        nodes: [
          ...
          },
          {
            ...
            job: "Complete the fixture implementation.",
            harnessId: "opencode",
            modelId: "fixture-model",
      ...
      const savedGraph = graphDefinitionV2Schema.parse(
